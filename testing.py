...
my_pos = [5,5,4]
my_dir = [4,8,9]
my_ray = rt.Ray(my_pos,my_dir) #testing raised exceptions when p and k are incorrectly-sized lists
print(f"my ray:{my_ray}")

test_element = elems.OpticalElement()
print(test_element.propagate_ray(test_ray)) #testing notimplemented error for "propagate ray" method
...
print(f"Intercept points of ray and spherical element:\n{test_spherical.intercept(new_ray)}") #testing intercept function