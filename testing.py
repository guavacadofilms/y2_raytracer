...
test_spherical = elems.SphericalRefraction(3, 0.5, 1, 1.2, 2)
...
incident_dir = [0, 1, 4]
surface_norm = [0, 2, 1]
unit_in_dir = elems.normalise_vector(incident_dir)
unit_surface_norm = elems.normalise_vector(surface_norm)
print(f"Refraction direction: {test_spherical.snell(unit_in_dir, unit_surface_norm)}")